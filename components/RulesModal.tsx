...
const RulesModal: React.FC<Props> = ({ show, onClose }) => {
  ...
  const renderRulesV2 = () => (
    <>
      <h2 style={{ color: '#1DB954' }}>🆕 SPIELANLEITUNG – Version 2</h2>
      <p>Hier kannst du deine alternative Spielvariante beschreiben.</p>
      <ul>
        <li>🔁 Neue Regeln, neues Glück!</li>
        <li>🔍 Vielleicht andere Wertung oder Spielmechanik.</li>
        <li>✍️ Diese Sektion kannst du frei gestalten.</li>
      </ul>
    </>
  );
