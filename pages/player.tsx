...
import { library, IconDefinitionOrPack } from '@fortawesome/fontawesome-svg-core';

library.add([faPlay, faPause, faBackward, faForward, faQrcode] as unknown as IconDefinitionOrPack);
